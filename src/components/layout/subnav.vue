<template>
  ...
  <div class="breadnav">
    <span @click="toggleSideBar" class="bars"> 
      ...
      <router-link id="aaa" class="breadnavs" to="/" style="cursor: pointer" tag="span">首页</router-link><span class="breadnavs" v-for="(item, index) in breadnav" :key = "index">{{item}}</span>
